...
//     let not = parseInt(prompt(ogrenci + ". Öğrenci notunu girin"))
//     toplamNot += not
...
// console.log(sayi);
// let tahmin = Number(prompt("Lütfen 1-10 arasında bir sayı giriniz..."))
// let hak = 3;
// let deneme = 1;
...
//     if(urun !== 'onayla'){
//         let fiyat = Number(prompt(urun + " ürünün fiyatını girin:"))
//         toplamFiyat += fiyat
//     }
// }
